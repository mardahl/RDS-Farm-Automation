...
Modified version of: https://github.com/andif888/convert-udp-fslogix
This quick and dirty version by @michael_mardahl github.com/mardahl
...
Start-Transcript -Path "d:\convertlog$((Get-Date).ToString("HHmmss"))."
...
ForEach ($file in $files) {
    ...
    (
        ...
        If ($MountError){
        Write-Host (ThisHHmmss) "Failed to mount" $sourcevhdx -ForegroundColor Yellow
